...
class App extends Component {
  ...
  tick = () => {
    ...
    if (seconds === 0) {
      this.setState({isGameOver: true, seconds: 0})
      clearInterval(this.timerId)
    }
  }
  ...
  onClickImage = id => {
    ...
    /* eslint-disable no-unused-vars */
    const randomImage =
      imagesListA[Math.floor(Math.random() * imagesList.length)]
    this.setState({currentImgId: randomImage.id})
    this.setState({currentImg: randomImage.imageUrl})
    if (currentImgId === id) {
  ...
  renderGameOver = () => {
    ...
    return (
      <div className="Gameover-img">
        ...
        <p>{score}</p>
        <br />
        <button type="button" onClick={this.onClickPlayAgainButton}>
          <img
        ...
        <div className="header-division">
          ...
          <div className="timer-score">
            ...
            <img
              ...
              className="timer"
            />
            <p className="paragraph-element">{seconds} sec</p>
          </div>
        </div>
        {isGameOver ? (
          this.renderGameOver()
          ...
          <div>
            <div className="ImageToBeDisplayed-div">
              <img
                src={currentImg}
                alt="match"
                className="ImageToBeDisplayed"
              />
            </div>
            <nav>
